...
export const DIRECTIVE_COMPOSITION_API_ROUTE_PREFIX =
...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/directive-compositon-api/routes').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/directive-solutions/routes').then(
        config => config.routes
      ),
  },
  {
    ...
    loadChildren: () =>
      import('./pages/naive/routes').then(config => config.routes),
  },
];
