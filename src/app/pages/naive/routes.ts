...
export const routes: Routes = [
  ...
  },
  {
    path: 'select',
    loadComponent: () =>
      import('./select/smart.component').then(c => c.SmartComponent),
    data: {
      label: 'Select [naive]',
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './select-as-component/reactive-forms-select-container.component'
      ).then(c => c.ReactiveFormsSelectContainerComponent),
    data: {
