...
export const routes: Routes = [
  ...
  },
  {
    path: 'context-menu',
    loadComponent: () =>
      import('./context-menu/products-list.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './disable-interactive-elements/disable-interactive-elements.component'
      ).then(c => c.DisableInteractiveElementsComponent),
    data: {
  ...
  },
  {
    path: 'ng-plural',
    loadComponent: () =>
      import('./ng-plural/ng-plural.component').then(c => c.NgPluralComponent),
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './open-external-links-in-new-tab/open-external-links-in-new-tab.component'
      ).then(c => c.OpenExternalLinksInNewTabComponent),
    data: {
  ...
  },
  {
    path: 'select',
    loadComponent: () =>
      import('./select/select-container.component').then(
        c => c.SelectContainerComponent
      ),
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./user-permission/user-permission.component').then(
        c => c.UserPermissionComponent
      ),
    data: {
